		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#sapeccfioriappproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapeccfioriappproject1-display": {
								"semanticObject": "sapeccfioriappproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.ecc.fioriapp.project1",
									"url": sap.ui.require.toUrl("sap/ecc/fioriapp/project1")
								}
							}
						}
					}
