sap.ui.define([
    ...
    'root/models/model'
], function (oController, oCreateModel) {
    'use strict';
    ...
    return oController.extend("root.controller.main", {
        ...
        onInit: function () {
            //1 - call method
            var oModel = oCreateModel.createJsonModel('./models/studentData.json');
            var oModel2 = oCreateModel.createJsonModel('./models/studentData2.json');
            var oModel3 = oCreateModel.createResourceModel();
            var oModel4 = oCreateModel. createXMLModel('./models/student3.xml');
