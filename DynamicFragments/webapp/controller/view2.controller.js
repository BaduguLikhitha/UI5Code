    ...
    return BaseController.extend("st.b33.simpleApp.controller.view2", {
        ...
        onSearch: function(oEvent){
            debugger;
             ...
             //Get Query string
             var oSearchInput = oEvent.getParameters("value");
            
           // Get Item Data
            var oItemData = this.getView().byId("idCities").getBinding("items");
         

          //Create Filter 
         var oFilterName = new Filter("CityName", FilterOperator.Contains, oSearchInput );
